<?php class Signers extends DatabaseObject
{
    protected static $table_name = "signers";
    ...
    public static function find_by_document($document_id)
    {
        $sql = "SELECT * FROM " . static::$table_name . " ";
        $sql .= "WHERE document_id='" . self::$database->escape_string($document_id) . "'";
    ...
    public static function find_by_email_and_doc_ids($document_id, $email)
    {
        $sql = "SELECT * FROM " . static::$table_name . " ";
        $sql .= "WHERE document_id='" . self::$database->escape_string($document_id) . "'";
        $sql .= " AND email='" . self::$database->escape_string($email) . "'";
        return static::find_by_sql($sql);  
    }

    public static function find_by_email_and_document_id($document_id, $email)
    {
        $sql = "SELECT * FROM " . static::$table_name . " ";
        $sql .= "WHERE document_id='" . self::$database->escape_string($document_id) . "'";
        $sql .= " AND email='" . self::$database->escape_string($email) . "'";
    ...
    static public function removeSigner($document_id, $email) {
