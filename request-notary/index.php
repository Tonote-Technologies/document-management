...
$signers = Signers::find_by_document_id($_GET['document_id']);
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-12 d-flex product-details-border position-relative pe-0">
                                        <table class="table table-borderless fs-13">
                                            ...
                                            <tbody>
                                                <?php $sn = 1; foreach ($signers as $value) { 
                                                    ...
                                                    ?>
                                                <tr class="mtable">
                                                    <td><span id="sr_no"><?php echo $sn++; ?></span>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex justify-content-left align-items-center">
                                                            <div class="avatar-wrapper">
                                                                <div class="avatar bg-light-primary me-50">
                                                                    <div class="avatar-content"><?php echo $initial ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex flex-column">
                                                                <h6 class="user-name text-truncate mb-0">
                                                                    ...
                                                                    class="text-truncate text-muted"><?php echo $value->email ?></small>
                                                                </h6><small
                                                                    class="text-truncate text-muted"><?php echo $value->phone ?></small>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>Signer</td>
